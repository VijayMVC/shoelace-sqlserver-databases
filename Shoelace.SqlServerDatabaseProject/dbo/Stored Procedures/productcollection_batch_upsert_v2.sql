...
CREATE PROCEDURE [dbo].[productcollection_batch_upsert_v2] 
@userMongoId NVARCHAR(50),
@productCollectionUpdateRecords productcollection_upsert_v2 READONLY 
...
ON Target.[shopify_product_id] = Source.[shopify_product_id] 
	AND Target.shopify_collection_id = Source.shopify_collection_id 
